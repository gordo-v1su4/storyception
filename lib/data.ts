...
export const archetypes: Archetype[] = [
  {
    ...
    example: "Sinners, Avatar-scale spectacle",
    desc: "Mythic progression with prestige-TV stakes, cultural specificity, and world-shifting reversals",
    categoryId: "film-tv",
  },
  {
    title: "SAVE THE CAT",
    subtitle: "PACING ENGINE",
    example: "KPop Demon Hunters, global four-quadrant hits",
    desc: "Propulsive blockbuster pacing with an unmistakable hook, midpoint flip, and emotional payoff",
    categoryId: "film-tv",
  },
  {
    title: "STORY CIRCLE",
    subtitle: "CHARACTER ENGINE",
    example: "Adolescence, The Pitt",
    desc: "Cyclical character pressure that returns transformed, bruised, and newly self-aware",
    categoryId: "film-tv",
  },
  {
    title: "THREE-ACT",
    subtitle: "BASE ENGINE",
    example: "Hamnet, prestige award drama",
    desc: "Clean cinematic escalation from intimate setup to irreversible confrontation",
    categoryId: "film-tv",
  },
  {
    title: "SEVEN-POINT",
    subtitle: "MILESTONE ENGINE",
    example: "Andor, political thrillers",
    desc: "Milestone-driven tension with moral pressure, reversals, and a hard-earned climax",
    categoryId: "film-tv",
  },
  {
    title: "LESTER DENT",
    subtitle: "PULP FICTION ENGINE",
    example: "One Battle After Another, edge thrillers",
    desc: "Trouble-first escalation with sharp satire, danger, cliffhangers, and final sting",
    categoryId: "film-tv",
  },
  {
    title: "SONG ARC",
    subtitle: "NARRATIVE MV",
    example: "iHeart/Grammy-level pop videos",
    desc: "Verse-chorus arc mapped to cinematic visual story, iconography, and emotional release",
    categoryId: "music-video",
  },
  {
    title: "PERFORMANCE MV",
    subtitle: "STAGE ENGINE",
    example: "Bad Bunny, Kendrick, Billie-scale stage films",
    desc: "Artist, dancers, crowd, camera, and lighting as the dramatic through-line",
    categoryId: "music-video",
  },
  {
    title: "VISUAL CONCEPT",
    subtitle: "ART FILM MV",
    example: "Hollywood MVA-level concept videos",
    desc: "Motif-driven visual systems with surreal escalation, symbolic pivots, and a hard emotional peak",
    categoryId: "music-video",
  },
  {
    title: "PROBLEM → SOLUTION",
    subtitle: "CLASSIC SPOT",
    example: "Super Bowl 2026 product demos",
    desc: "Agitate a clear pain, reveal the fix, and make the product emotionally unavoidable",
    categoryId: "commercial",
  },
  {
    title: "LIFESTYLE",
    subtitle: "ASPIRATION SPOT",
    example: "Clio-winning fashion, auto, beverage",
    desc: "Aspirational world-building with identity, ritual, product texture, and brand memory",
    categoryId: "commercial",
  },
  {
    title: "MINI-STORY",
    subtitle: "CHARACTER SPOT",
    example: "Funniest Super Bowl character spots",
    desc: "Relatable setup, comic or emotional twist, brand-as-hero, and memorable lockup",
    categoryId: "commercial",
  },
]
